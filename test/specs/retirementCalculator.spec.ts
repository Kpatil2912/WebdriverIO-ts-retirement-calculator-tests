...
describe('Retirement Calculator - Form Validation Tests', () => {
  ...
  it('Should submit form with all required fields filled', async () => {
    ...
    allureReporter.startStep(
      'Test case started: should submit form with all required fields filled'
    );

    // Test Logic
    await (
      await retirementCalculatorPage.fillFormRequired(retirementCalculatorInputDao)
    ).clickOnCalculate();
    ...
    logger.info(
      'Test case completed successfully: should submit form with all required fields filled'
    );
  });
  ...
  it('User should be able to submit form with all fields filled in', async () => {
    ...
    allureReporter.addSeverity('critical');
    allureReporter.startStep(
      'Test case started: User should be able to submit form with all fields filled in'
    );
    ...
    allureReporter.endStep();
    logger.info(
      'Test case completed successfully: User should be able to submit form with all fields filled in'
    );
  });
  ...
  it('Should display error when submitting form without filling required fields', async () => {
    //Report Setup
    logger.info(
      'Test case started: should display error when submitting form without filling required fields'
    );
    allureReporter.addStory('Form Validation');
    allureReporter.addSeverity('critical');
    allureReporter.startStep(
    ...
    expect(await retirementCalculatorPage.getInputAlertText()).toContain(
      validationRetirementFormData.inputAlertDesc
    );

    allureReporter.endStep();
    logger.info(
      'Test case completed successfully: should display error when submitting form without filling required fields'
    );
  });
  ...
  it('should hide Social Security Override input when toggle is set to No', async () => {
    ...
    allureReporter.addSeverity('critical');
    allureReporter.startStep(
      'Test case started: should hide Social Security Override input when toggle is No'
    );
    ...
    allureReporter.endStep();
    logger.info(
      'Test case completed successfully: should hide Social Security Override input when toggle is No'
    );
  });
  ...
  it('should show Social Security Override input when toggle is set to Yes', async () => {
    ...
    allureReporter.addSeverity('critical');
    allureReporter.startStep(
      'Test case started: should show Social Security Override input when toggle is Yes'
    );
    ...
    allureReporter.endStep();
    logger.info(
      'Test case completed successfully: should show Social Security Override input when toggle is Yes'
    );
  });
  ...
  it('should show error if Retirement Age is less than Current Age', async () => {
    //Report Setup
    logger.info(
      'Test case started: should show error if Retirement Age is less than or equal to Current Age'
    );
    allureReporter.addStory('Form Validation');
    allureReporter.addSeverity('critical');
    allureReporter.startStep(
    ...
    expect(await retirementCalculatorPage.getInvalidRetirementAgeError()).toContain(
      validationRetirementFormData.retirementAgeAlertDEsc
    );

    allureReporter.endStep();
    logger.info(
      'Test case completed successfully: should show error if Retirement Age is less than or equal to Current Age'
    );
  });
  ...
  it('should allow user to update default calculator values and submit form', async () => {
    ...
    allureReporter.addSeverity('critical');
    allureReporter.startStep(
      'Test case started: should allow user to update default calculator values'
    );
    ...
    allureReporter.endStep();
    logger.info(
      'Test case completed successfully: should allow user to update default calculator values'
    );
  });
});
